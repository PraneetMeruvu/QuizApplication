    ...
    if request.method == "POST":
        ...
        if password == password2:
            ...
            # check if username is not same
                ...
                new_profile = Profile.objects.create(user=user_model, dateOfBirth=dateOfBirth, accountType=accountType)
                new_profile.save()


                if new_profile.accountType == 'teacher':
                    return redirect('dashboard')
                elif new_profile.accountType == 'student':
